    ...
    var game = {
        ...
        nextQuestion: function () {
            ...
            if (number < questionArray.length) {
                ...
                game.hide()
                $("#game-result").show()
                $("#game-result").text("Game Over! You got " + correct + " questions correct! You got " + incorrect + " questions wrong. :(")
                setTimeout(function () {
                    game.reset()
                }, 5000)
            }
        ...
        result: function (selectedAnswer) {
            ...
            if (time === 0) {
                incorrect++;
                $("#game-result").text("You ran out of time. :(  The correct answer is: " + displayAnswer)
            } else if (selectedAnswer === correctAnswer) {
                correct++;
                $("#game-result").text("The correct answer is: " + displayAnswer + ". Congratulations! You got it right!!!")
            } else if (selectedAnswer !== correctAnswer) {
                incorrect++;
                $("#game-result").text("The correct answer is: " + displayAnswer + ". You got it wrong. :(")
            }
            setTimeout(function () {
                game.show()
                game.start()
